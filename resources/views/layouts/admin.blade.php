...
<body>
  <div class="container">
    <header>
      ...
      <div>
        <a class="btn btn-primary" style="list-style: none; text-decoration:none; margin-right:10px; font-size:15px; padding:15px;" href="{{ route('admin.home') }}">Back to Home</a>
      </div>
    </header>
    ...
    <footer style="margin-top:28px; text-align:center; color:#ffffff; border-radius: 0 0 10px 10px; ">
      &copy; {{ date('Y') }} Scholarship Management System
    </footer>
  </div>
</body>
</html>

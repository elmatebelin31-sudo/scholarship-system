  ...
  <div class="container">
    <header>
      ...
      <nav>
        ...
        <div class="cta">
          <a class="btn btn-outline" href="<?php echo e(route('student.login')); ?>"   style="font-size: 14px;">Student Login</a>
          <a class="btn btn-primary" href="<?php echo e(route('student.register')); ?>"   style="font-size: 12px;">Student Sign Up</a>
        </div>
      </nav>
    </header>
...
<section id="admin-actions" class="card" style="margin-top:20px; text-align:center;">
  ...
  <div style="display:flex; justify-content:center; gap:25px; flex-wrap:wrap; margin-top:15px;">
    ...
    <a class="btn btn-outline" href="<?php echo e(route('admin.create')); ?>">Add Admin</a>
    <a class="btn btn-outline" href="<?php echo e(route('admin.login')); ?>">Admin Login</a>
    <a class="btn btn-outline" href="<?php echo e(route('admin.applications')); ?>">View Applications</a>
  </div>
</section>
<?php endif; ?>
        </div>
...
<form action="<?php echo e(route('applications.store')); ?>" method="POST" enctype="multipart/form-data" id="applicationForm">
<?php echo csrf_field(); ?>
...
<div id="printModal" class="print-modal" role="dialog" aria-hidden="true">
    <div class="print-sheet" id="printSheet">
        ...
        <div style="display:flex; align-items:center; justify-content:space-between; margin-bottom:20px;">
            <div>
                <img src="<?php echo e(asset('images/logo.png')); ?>" alt="Logo" style="width:60px; height:60px;">
            </div>
...
<div style="display:flex; gap:10px; justify-content:flex-end; margin-top:25px;">
    ...
    <footer style="margin-top:34px; text-align:center; color:var(--muted); font-size:13px;">
      © <?php echo e(date('Y')); ?> Scholarship Management System — your Study Buddy.
    </footer>
  </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    <?php if($errors->any()): ?>
        <?php $__currentLoopData = $errors->all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $error): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            messages.push({type: 'error', text: "<?php echo e($error); ?>"}); 
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    <?php endif; ?>

    <?php if(session('success')): ?>
        messages.push({type: 'success', text: "<?php echo e(session('success')); ?>"});
    <?php endif; ?>
...
<?php /**PATH C:\xampp\htdocs\scholarship-system\resources\views/welcome.blade.php ENDPATH**/ ?>